---
name: SerializedArrays.jl bug report
about: Create a bug report to help us improve SerializedArrays.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("SerializedArrays")`:
```julia
julia> using Pkg; Pkg.status("SerializedArrays")
[YOUR OUTPUT HERE]
```
